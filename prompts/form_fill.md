...
- checkbox_group: despite the name, this is NOT a yes/no field — do not answer "yes"/"no" here even if the options happen to look like a Да/Нет pair. It behaves exactly like radio_group above: the field spec includes an "options" list: return the EXACT option text you want to select, or "open: <your custom answer>" if none fit and "Свой вариант"/"Другое" is listed
